...
-- beautiful.init(os.getenv("XDG_CONFIG_HOME") .. "/awesome/themes/sugarglass/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Rounded shape definitions
	local left_round = function(cr, width, height)
	...
	s.mytaglist = wibox.container.margin(s.mytaglist, 0, dpi(5))
	s.mytaglist = wibox.container.background(s.mytaglist, beautiful.bg_focus, left_round)

	-- Create and style right widget container
	s.rightwidgets = wibox.widget{
		layout = wibox.layout.fixed.horizontal,
		bat,
		mytextclock,
	}
	s.rightwidgets = wibox.container.margin(s.rightwidgets, dpi(10))
	s.rightwidgets = wibox.container.background(s.rightwidgets, beautiful.bg_focus, right_round)
